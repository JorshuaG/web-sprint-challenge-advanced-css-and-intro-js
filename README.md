...
Acessibility on a website is the responsiveness to a website from user changes. Such as using a mobile device, screen readers, or zoom functions for text for better visiability, without compromising the effectiveness of the website itself.

2. Talk about 3 different things you can do to ensure your website is accessible.

Using a viewport meta tag allowing the use of media queries. Using scalable units as well as adding alts to images for screen readers. Semantic html also contributes to the accesibility of a website.

3. How would you explain the concept of a variable to someone new to programming?

A name given to a set of data.

4. What is the purpose of using functions in code?

Achieve more complex processes writing code, with more reusable tools allowing Dryer code and less bugs.
